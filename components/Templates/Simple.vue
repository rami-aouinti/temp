<template>
  <div id="pdf-content">
    <v-row>
          ...
          <div class="pa-4">
            ...
            <div>
              <HeaderSection
                :printStyle="printStyle"
                label="Education"
                pathIcon="M12,3L1,9L12,15L21,10.09V17H23V9M5,13.18V17.18L12,21L19,17.18V13.18L12,17L5,13.18Z"
                size="20"
                color="white"
              />
      ...
      <v-col cols="8">
        <v-row>
          <Experience :printStyle="printStyle"></Experience>
          <Experience :printStyle="printStyle"></Experience>
          <Experience :printStyle="printStyle"></Experience>
        </v-row>
      </v-col>
